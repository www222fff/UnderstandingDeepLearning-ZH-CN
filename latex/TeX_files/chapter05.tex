...
\begin{align}
	...
	&= argmax_{\phi} \left[ \prod_{i=1}^{I} Pr(y_i|f(x_i, \phi)) \right]  \\ \tag{5.1}
\end{align} 
...
\begin{align}
	...
	&= argmax_{\phi} \left[ \sum_{i=1}^{I} \log Pr(y_i|f(x_i, \phi)) \right] \tag{5.3}
\end{align} 
...
\begin{align}
	...
	&= argmin_{\theta} \left[ -\int_{-\infty}^{\infty} q(y) \log [Pr(y|\theta)] dy \right],  \tag{5.29}
\end{align}
...
\begin{align}
	...
	&= argmin_{\theta} \left[ -\sum_{i=1}^{I} \log [Pr(y_i|\theta)] \right], \tag{5.30}
\end{align} 
