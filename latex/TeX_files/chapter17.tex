...
\begin{align}
&Pr(z = n) = \lambda_n \\
&Pr(x|z = n) = \mathcal{N}_{x}(\mu_n, \sigma^2_n). \tag{17.3}
\end{align} 
...
&= \sum_{n=1}^{N} \lambda_n \cdot \mathcal{Norm}_x(\mu_n, \sigma^2_n). \tag{17.4}
\end{align} 
...
&= \int \text{Norm}_x\left[f(z, \phi), \sigma^2 I\right] \cdot \text{Norm}_z[0, I] dz. \tag{17.7}
\end{align} 
...
&= \log \left[ \int \frac{q(z)}{q(z)} Pr(x, z|\phi) dz \right], \tag{17.14}
\end{align} 
...
&= \log [Pr(x|\phi)] - D_{KL} \left[ q(z|\theta) || Pr(z|x, \phi) \right]. \tag{17.17}
\end{align} 
...
&= \int q(z|\theta) \log [Pr(x|z, \phi)] dz - D_{KL} \left[ q(z|\theta) || Pr(z) \right], \tag{17.18}
\end{align} 
...
&\approx \frac{1}{N} \sum_{n=1}^{N} \frac{Pr(x|z_n)Pr(z_n)}{q(z_n)}, \tag{17.28}
\end{align} 
...
&\approx \frac{1}{I} \sum_{i=1}^{I} f[x_i] \frac{\partial}{\partial\phi} \log(P_{r(x_i|\phi)}). \tag{17.34}
\end{align} 
